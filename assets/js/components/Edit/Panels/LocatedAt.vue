...
import {
  ...
  dependencyField,
  enableField,
  loadLocationField, disableFields, enableFields,
...
export default {
  ...
  data() {
    return {
      schema: {
        fields: {
          city: createMultiSelect('City', {model: 'location.regionWithParents', required: true, validator: validatorUtil.required}),
          library: createMultiSelect('Library', {model: 'location.institution', required: true, validator: validatorUtil.required, dependency: 'regionWithParents', dependencyName: 'city'}),
