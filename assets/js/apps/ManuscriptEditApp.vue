...
const panelComponents = require.context('../Components/Edit/Panels.vue', false, /[/](?:LocatedAt|Content|Person|Date|Origin|OccurrenceOrder|Identification|Bibliography|GeneralManuscript|Management)[.]vue$/)
