...
const panelComponents = require.context('../Components/Edit/Panels.vue', false, /[/](?:Person|BasicBook|Url|Identification|GeneralBibItem|Management)[.]vue$/)
        ...
        setData() {
            if (this.book != null) {
                ...
                this.model.basic = {
                    ...
                    year: this.book.year,
                    forthcoming: this.book.forthcoming,
                    city: this.book.city,
